# Worker Skill Endpoints

## 1. Create Worker Skill
- **Method**: `POST`
- **URL**: `/api/v1/worker-skills`
- **Permission**: `worker-skill:create`
...
## 2. List Worker Skills
- **Method**: `GET`
- **URL**: `/api/v1/worker-skills`
- **Permission**: `worker-skill:read`
...
## 3. Get Worker Skill by ID
- **Method**: `GET`
- **URL**: `/api/v1/worker-skills/:id`
- **Permission**: `worker-skill:read`
...
## 4. Update Worker Skill
- **Method**: `PATCH`
- **URL**: `/api/v1/worker-skills/:id`
- **Permission**: `worker-skill:update`
...
## 5. Delete Worker Skill
- **Method**: `DELETE`
- **URL**: `/api/v1/worker-skills/:id`
- **Permission**: `worker-skill:delete`
- **Validation**: UUID param schema.
- **Request**: Empty body.
