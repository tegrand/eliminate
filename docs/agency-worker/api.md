# Agency Worker Endpoints

## 1. Create Agency Worker
- **Method**: `POST`
- **URL**: `/api/v1/agency-workers`
- **Permission**: `agency-worker:create`
...
## 2. List Agency Workers
- **Method**: `GET`
- **URL**: `/api/v1/agency-workers`
- **Permission**: `agency-worker:read`
...
## 3. Get Agency Worker by ID
- **Method**: `GET`
- **URL**: `/api/v1/agency-workers/:id`
- **Permission**: `agency-worker:read`
...
## 4. Update Agency Worker
- **Method**: `PATCH`
- **URL**: `/api/v1/agency-workers/:id`
- **Permission**: `agency-worker:update`
...
## 5. Delete Agency Worker
- **Method**: `DELETE`
- **URL**: `/api/v1/agency-workers/:id`
- **Permission**: `agency-worker:delete`
- **Validation**: UUID param schema.
- **Request**: Empty body.
