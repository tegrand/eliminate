...
export default function AttendanceStats() {
  const stats = [
    { label: "PRESENT TODAY", value: "1,245", subtitle: "Currently present", icon: CheckCircle2, color: "text-green-600", bg: "bg-green-50" },
    { label: "ABSENT", value: "42", subtitle: "Not logged in", icon: XCircle, color: "text-red-600", bg: "bg-red-50" },
    { label: "LATE", value: "18", subtitle: "Arrived late", icon: Clock, color: "text-orange-500", bg: "bg-orange-50" },
    { label: "PENDING VERIFICATION", value: "156", subtitle: "Awaiting approval", icon: AlertCircle, color: "text-indigo-600", bg: "bg-indigo-50" },
  ];
