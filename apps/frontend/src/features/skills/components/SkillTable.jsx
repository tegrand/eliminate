...
export default function SkillTable({ data, loading, onEdit, onDelete }) {
  const columns = [
    { key: "code", title: "Skill Code", render: (row) => row.code },
    { key: "name", title: "Skill Name", render: (row) => row.name },
