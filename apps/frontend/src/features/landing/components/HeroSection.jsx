...
export default function HeroSection() {
  return (
    <section className="relative pt-12 pb-10 md:pt-16 md:pb-12 overflow-hidden bg-gradient-to-b from-gray-50/50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to={ROUTES.SIGNUP}
              className="w-full sm:w-auto text-base font-medium bg-blue-600 hover:bg-blue-700 text-white px-7 py-3.5 rounded-xl shadow-lg shadow-blue-600/25 transition-all flex items-center justify-center gap-2"            >
          ...
          {/* Trust Highlights */}
          <div className="mt-10 pt-6 border-t border-gray-100 flex flex-wrap items-center justify-center gap-6 text-xs font-medium text-gray-500">
