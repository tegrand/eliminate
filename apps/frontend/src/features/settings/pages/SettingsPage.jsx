          ...
          <div className="max-w-md">
            ...
            <div className="relative">
              <input
                ...
                placeholder="e.g. 10"
                className="w-full pl-3 pr-10 py-1 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col">
        ...
        <div className="px-3 py-2 bg-gray-50 border-t border-gray-200 flex justify-end">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-900 text-white rounded-md text-sm hover:bg-gray-800 transition-colors"
          >
            Change Password
          </button>
        </div>
