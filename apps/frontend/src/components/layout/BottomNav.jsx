...
export default function BottomNav() {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 h-[64px] bg-white border-t border-slate-100 flex items-center justify-around z-[100] shadow-[0_-4px_10px_rgba(0,0,0,0.03)] px-2">
      {navItems.map((item, idx) => {
        ...
        return (
          ...
          >
            ...
            {item.isActive && (
              <span className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-[3px] bg-blue-600 rounded-b-full transition-all duration-300" />
            )}
