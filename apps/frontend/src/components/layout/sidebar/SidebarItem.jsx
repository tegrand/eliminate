    ...
    return (
      <div className="space-y-1">
        <button
          ...
          className={clsx(
            "w-full flex items-center justify-between gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500",
          ...
          <div className="pl-9 space-y-1 mt-1">
            {item.subItems.map((sub, idx) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    "block rounded-md px-3 py-2 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500",
